...
import {
  Tabs, Input, Button, message, Avatar, Dropdown, Menu,
  Typography, Divider, Checkbox, Space, Modal,
} from 'antd';
import {
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          {/* 左侧文字内容 */}
          <div style={{ flex: 1, minWidth: 300, color: '#fff',marginTop: '-500px' }}>
            {/* 品牌标签 */}
            <div style={{
